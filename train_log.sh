...
# global: chart_5_cap_5_min_wf-2020-09-04-11-09,
# focus:  chart_5_cap_5_min_wf-2020-09-04-00-30, 
# dataset: 20200903_30000,



# chart_5_cap_5_min_wf-2020-09-04-00-30


python create_input_files.py --dataset chart --karpathy_json_path data/20200903_30000/karparthy_dataset.json --image_folder data/20200903_30000/svg --output_folder data/20200903_30000/deal_no_focus --image_type svg --need_text --max_element_number 100 
...
# local: chart_5_cap_5_min_wf-2020-09-04-10-15
# dataset: 20200904_50000
...
python test_module.py --img data/20201217_20000/svg/2999.svg  --model checkpoint/chart_5_cap_5_min_wf-2020-12-17-22-48/epoch_119_bleu_0.5361.pth.tar --word_map data/20201217_20000/deal_no_focus/WORDMAP_chart_5_cap_5_min_wf.json  --image_type svg --need_text --max_element_number 100 --replace_token

python train.py --data_folder data/20201218_100000/deal_no_focus --svg_element_number 100 --data_name chart_5_cap_5_min_wf --image_type svg --input_nc 4,2,4,3,1 --output_nc 5,5,5,5,5 --emb_dim 512 --attention_dim 512 --decoder_dim 512 --need_text --need_random

python test_module.py --img data/20201218_100000/svg/2999.svg  --model checkpoint/chart_5_cap_5_min_wf-2020-12-18-02-14/epoch_025_bleu_0.5510.pth.tar --word_map data/20201218_100000/deal_no_focus/WORDMAP_chart_5_cap_5_min_wf.json  --image_type svg --need_text --max_element_number 100 --replace_token


# remote
python test_module.py --img data/20201218_100000/svg/2999.svg  --model checkpoint/chart_5_cap_5_min_wf-2020-12-18-02-14/epoch_119_bleu_0.5916.pth.tar --word_map data/20201218_100000/deal_no_focus/WORDMAP_chart_5_cap_5_min_wf.json  --image_type svg --need_text --max_element_number 100 --replace_token

# 20201219

# fix the problem in the order of the input
python train.py --data_folder data/20201219_100000/deal_no_focus --svg_element_number 100 --data_name chart_5_cap_5_min_wf --image_type svg --input_nc 4,2,4,3,1 --output_nc 5,5,5,5,5 --emb_dim 512 --attention_dim 512 --decoder_dim 512 --need_text --need_random
...
# create dataset
./run.sh 20220301_1000 50000


# python create_input_files.py --dataset chart --karpathy_json_path data/20220301_1000/karparthy_dataset.json --image_folder data/20220301_1000/svg --output_folder data/20220301_1000/deal_no_focus --image_type svg --need_text --max_element_number 150 

# python train.py --data_folder data/20220301_1000/deal_no_focus --svg_element_number 150 --data_name chart_5_cap_5_min_wf --image_type svg --input_nc 4,2,4,3,1 --output_nc 5,5,5,5,5 --emb_dim 512 --attention_dim 512 --decoder_dim 512 --need_text --need_random
...
python train.py --data_folder data/20201217_20000/deal_no_focus --svg_element_number 150 --data_name chart_5_cap_5_min_wf --image_type svg --input_nc 4,2,4,3,1 --output_nc 5,5,5,5,5 --emb_dim 512 --attention_dim 512 --decoder_dim 512 --need_text --need_random
#chart_5_cap_5_min_wf-2022-03-01-23-38

# python train.py --data_folder data/20201217_20000/deal --svg_element_number 100 --data_name chart_1_cap_5_min_wf --image_type svg --input_nc 4,2,4,3,1,1 --output_nc 5,5,5,5,5,5 --emb_dim 512 --attention_dim 512 --decoder_dim 512 --need_text --need_random
